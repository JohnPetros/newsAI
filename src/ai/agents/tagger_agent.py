...
tagger_agent = Agent(
    ...
    instructions=dedent(
        """
        Assign at least five relevant Portuguese tags to each blog post, ensuring they are coherent with the content and not already included in the post's title.
